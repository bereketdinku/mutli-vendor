 ...
 */ function UploadButton(props) {
    ...
    const [isManualTriggerDisplayed, setIsManualTriggerDisplayed] = React.useState(false);
        ...
        children: [
            /*#__PURE__*/ jsxRuntime.jsxs("label", {
                ...
                children: [
                    ...
                    shared.contentFieldToContent($props.content?.button, styleFieldArg) ?? getUploadButtonContents(fileTypes)
                ]
            }),
