 ...
 * =============================================================================
 */
declare const PresignedBaseSchema: S.Struct<{
    key: S.$String;
    fileName: S.$String;
...
declare const MPUResponseSchema: S.extend<S.Struct<{
    key: S.$String;
    fileName: S.$String;
    fileType: S.Schema<FileRouterInputKey, FileRouterInputKey, never>;
    fileUrl: S.$String;
...
declare const PSPResponseSchema: S.extend<S.Struct<{
    key: S.$String;
    fileName: S.$String;
    fileType: S.Schema<FileRouterInputKey, FileRouterInputKey, never>;
    fileUrl: S.$String;
...
declare const PresignedURLResponseSchema: S.$Array<S.Union<[S.extend<S.Struct<{
    key: S.$String;
    fileName: S.$String;
    fileType: S.Schema<FileRouterInputKey, FileRouterInputKey, never>;
    fileUrl: S.$String;
 ...
 * =============================================================================
 */
declare const UploadActionPayload: S.Struct<{
    files: S.$Array<S.Struct<{
        name: S.$String;
        size: S.$Number;
        type: S.$String;
    }>>;
    input: S.Schema<Json, Json, never>;
}>;
declare const FailureActionPayload: S.Struct<{
    fileKey: S.$String;
    uploadId: S.NullOr<S.$String>;
    storageProviderError: S.PropertySignature<"?:", string | undefined, never, "?:", string | undefined, never>;
    fileName: S.$String;
}>;
declare const MultipartCompleteActionPayload: S.Struct<{
    fileKey: S.$String;
    uploadId: S.$String;
 ...
 */
type PresignedBase = S.Schema.Type<typeof PresignedBaseSchema>;
type PSPResponse = S.Schema.Type<typeof PSPResponseSchema>;
type MPUResponse = S.Schema.Type<typeof MPUResponseSchema>;
type PresignedURLs = S.Schema.Type<typeof PresignedURLResponseSchema>;
/**
...
declare const isActionType: (input: unknown) => input is "upload" | "failure" | "multipart-complete";
/**
...
declare const isUploadThingHook: (input: unknown) => input is "callback";
/**
